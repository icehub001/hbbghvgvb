    ...
    function totarget(CFgo)
        ...
        local Window = create:Win("Netherite Hub")
    ...
    Main:Button("Join Discord Netherite Hub ", function(value)
    ...
    Main:Button("Copy Link Discord Netherite Hub ", function()
        setclipboard("https://discord.gg/6PbkWsfKeu")
    end)
    ...
    HEEMENCHIP:Label("New Auto Farm", function()
    end)

    HEEMENCHIP:Label("Random Event", function()
    end)

    HEEMENCHIP:Label("New Part All function", function()
    end)

    HEEMENCHIP:Label("Level Lock 2200", function()
    end)

    HEEMENCHIP:Label("Auto Farm Candy", function()
    end)

    HEEMENCHIP:Label("New Fast attack no cool down", function()
    end)
        ...
        tab:Toggle("Auto Farm",false,function(d)
            if d then
                if FarmMethod == nil then
                    create:Notifile("Netherite Hub", "Select Farm Method" ,5)
                else
